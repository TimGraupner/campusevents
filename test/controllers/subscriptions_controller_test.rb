...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { attendee_id: @subscription.attendee_id, event_id: @subscription.event_id } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { attendee_id: @subscription.attendee_id, event_id: @subscription.event_id } }
